...
public class Note {
    ...
    public Note( int breakAmt, String day, String subject, int category, int setStartTime, int setEndTime, int endStartTime, int endEndTime, String description, boolean isClicked) {
